/******************************************************************************
 *  Compilation:  javac OrdTopologicaPesos.java
 *  Execution:    java  OrdTopologicaPesos filename.txt delimiter
 ...
 *  Runs in O(E + V) time.
 *
 *  % java OrdTopologicaPesos jobs.txt "/"
 *  Calculus
 *  Linear Algebra
 *  Introduction to CS
...
/**
 *  The {@code OrdTopologicaPesos} class represents a data type for 
 ...
 *  See {@link OrdTopologicaPesosX} for a nonrecursive queue-based algorithm
 ...
 *  @author Kevin Wayne
 */
public class OrdTopologicaPesos {
     ...
     * @param G the digraph
     */
    public OrdTopologicaPesos(Digraph G) {
     ...
     */
    /**/
    public OrdTopologicaPesos(EdgeWeightedDigraph G) {
    ...
    /**
     * Unit tests the {@code OrdTopologicaPesos} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        OrdTopologicaPesos topological = new OrdTopologicaPesos(sg.digraph());
